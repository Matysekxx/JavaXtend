...
public final class IO {
    ...
    /** The shared writer instance for writing to the standard error stream. */
    private static final JXWriter ERROR_WRITER = new JXWriter(System.err, true);
    ...
    public static void printERR(Object obj) {
        ERROR_WRITER.print(ConsoleColors.RED.colorize(obj.toString()));
    }
    ...
    public static void printlnERR(Object obj) {
        ERROR_WRITER.println(ConsoleColors.RED.colorize(obj.toString()));
    }
