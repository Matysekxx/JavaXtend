...
class ImmutableTuple3Test {

    @Test
    @DisplayName("Should create an immutable triple and get its elements")
    void testCreationAndGetters() {
        Tuple3<String, Integer, Boolean> triple = ImmutableTuple3.of("Test", 123, true);
    ...
    void testEqualsAndHashCode() {
        Tuple3<String, Integer, Boolean> triple1 = ImmutableTuple3.of("A", 1, true);
        Tuple3<String, Integer, Boolean> triple2 = ImmutableTuple3.of("A", 1, true);
        Tuple3<String, Integer, Boolean> triple3 = ImmutableTuple3.of("B", 2, false);
    ...
    void testNullValues() {
        Tuple3<String, Integer, Boolean> triple = ImmutableTuple3.of(null, null, null);
    ...
    void testToString() {
        Tuple3<String, Integer, Boolean> triple = ImmutableTuple3.of("Hello", 2024, false);
    ...
    void testToList() {
        Tuple3<String, Integer, Boolean> triple = ImmutableTuple3.of("One", 2, true);
    ...
    void testToMutable() {
        ImmutableTuple3<String, Integer, Boolean> immutable = ImmutableTuple3.of("A", 1, true);
        JXTuple3<String, Integer, Boolean> mutable = immutable.toMutable();
        ...
        assertInstanceOf(JXTuple3.class, mutable);
    }
}